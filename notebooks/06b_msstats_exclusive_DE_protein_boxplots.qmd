...
3. **Prepare raw Spectronaut** PG.Quantity values (long format, log2-transformed)
4. **Prepare MSstats normalised** ProteinLevelData abundances
...
limma_exclusive <- comparison_df %>%
  ...
  # If Protein is still NA, try matching Gene back to dictionary
  mutate(
    Protein = case_when(
