...
print("Empirical Permutation Test Results:")
print(empirical_results)
```

```{r}
# --- 10. Visualize the Permutation Results ---
# This plots the bell curve of random chance vs your actual findings
